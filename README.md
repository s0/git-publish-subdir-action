...
| `USERNAME` | The username the autogenerated commit will use. If unset, uses the commit pusher's username. | No
| `EMAIL` | The username the autogenerated commit will use. If unset, uses the commit pusher's email. | No
